...
import { getUserInformation, getUserProfile } from "../../services/redux/user";
...
export default function Profile() {
  ...
  useEffect(() => {
    const tempCTA = [];
    if (profileForCV.aboutMe?.description?.length === 0) tempCTA.push("Add About Me");
    if (profileForCV.education?.length === 0) tempCTA.push("Add Education");
    if (profileForCV.workExperience?.length === 0) tempCTA.push("Add Work Experience");
    ...
    if (profileForCV.personalProjects?.length === 0) tempCTA.push("Add Personal Projects");
    if (profileForCV.certificates?.length === 0) tempCTA.push("Add Certificates");
      ...
      <Wrapper className="">
        <div className="grid grid-cols-10 gap-6">
          ...
          <div className="md:col-span-7 col-span-10 gap-6 grid">
            ...
            <PersonalProject personalProjectList={profileForCV.personalProjects} />
